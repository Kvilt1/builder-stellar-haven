  ...
  return (
    <div className="flex items-center h-14 py-2.5 px-3 bg-white border-b border-[#E1E1E1]">
      ...
      <div className="flex items-center gap-3 flex-1">
        ...
        <button
          onClick={onBack}
          className="flex items-center justify-center w-9 h-9 rounded-full bg-[#ECEFF1] hover:bg-gray-300 transition-colors"
        >
          <svg
            width="14"
            height="14"
        ...
        {/* Username Badge - Exact Figma specs */}
